...
colors:
  ...
  text-muted: "#5d6970"
  text-light: "#9A9A9A"
  accent-light: "rgba(0, 109, 111, 0.08)"
  accent-medium: "rgba(0, 109, 111, 0.15)"
  border: "rgba(0, 109, 111, 0.2)"
  card-bg: "rgba(0, 109, 111, 0.04)"
  positive: "#0a8f4f"
  negative: "#b42318"
...
- **Fonts** — already set to **Inter** (display) / **Segoe UI** (body); ignore any preset font name lingering in prose.
