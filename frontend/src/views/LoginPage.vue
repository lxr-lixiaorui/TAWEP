...
const copy = computed(() => app.locale === 'zh' ? {
  ...
  examDate: '计划考试日期（可选）', examDateHint: '距离考试还有 0–7 天时，每次评分只消耗 2 credits；考试当天登录还会收到一份祝福。',
  ...
  examDate: 'Planned exam date (optional)', examDateHint: 'When your exam is 0–7 days away, each evaluation costs only 2 credits. You will also receive an exam-day good-luck message.',
